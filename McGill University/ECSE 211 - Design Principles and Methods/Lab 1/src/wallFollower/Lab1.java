...
// Right motor connected to output B
	...
	private static final EV3LargeRegulatedMotor touchMotor = new EV3LargeRegulatedMotor(LocalEV3.get().getPort("B"));
...
// Main entry point - instantiate objects used and set up sensor
	...
	public static void main(String [] args) {
		...
		BangBangController bangbang = new BangBangController(leftMotor, rightMotor, touchMotor,
