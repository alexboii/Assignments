...
public class Odometer extends Thread {
	...
	public void run() {
		...
		while (true) {
			...
			leftDistance = (TIMES_TWO * Math.PI * Lab3.WHEEL_RADIUS * (nowTachoL - lastTachoL)) / FULL_CIRCLE;
			rightDistance = (TIMES_TWO * Math.PI * Lab3.WHEEL_RADIUS * (nowTachoR - lastTachoR)) / FULL_CIRCLE;
