...
public class Odometer extends Thread {
	...
	public void run() {
		...
		while (true) {
			...
			leftDistance = (TIMES_TWO * Math.PI * Lab2.WHEEL_RADIUS * (nowTachoL - lastTachoL)) / FULL_CIRCLE;
			rightDistance = (TIMES_TWO * Math.PI * Lab2.WHEEL_RADIUS * (nowTachoR - lastTachoR)) / FULL_CIRCLE;
			...
			changeTheta = (leftDistance - rightDistance) / Lab2.TRACK;
